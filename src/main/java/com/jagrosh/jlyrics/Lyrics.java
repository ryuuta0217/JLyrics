...
public class Lyrics
{
    private final String artwork, title, author, content, url, source;

    protected Lyrics(String atwork, String title, String author, String content, String url, String source)
    {
        this.artwork = atwork;
        this.title = title;
        this.author = author;
    ...
    /**
     * The artwork URL of song
     *
     * @return the song artwork URL
     */
